...
<body>
    <?php
        ...
        if (!(checkLogin() and $_SESSION['level'] == 2)) accessDenied();
    ?>
    <br>
    <div class="back pointer" onclick="history.back()"><img src="../images/back.png" alt="">Balik</div>
    <div class="main">
        <form action="./c_import.php" method="post" enctype="multipart/form-data" class=" vertical">
            <div class="vertical space-between max-height">
                <div class="center">Import Warna Produk Dari Fail CSV</div>
                ...
                <p>
                    Sila mengenal pasti format fail anda ialah "Nama, Warna, Nama Gambar"<br>
